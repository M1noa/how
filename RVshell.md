...
### UPDATE: I made a windows batch script that does it all automatically, from installing python, to compiling the code, its all userfriendly: [🐧.zip](https://catlitter.minoa.cat/api/view/0137b23d50.zip)
###
